...
int main(int argc, char **argv)
{
  ...
  while(ros::ok())
  {
    rviz_visualizer.publishCube(Eigen::Vector3d(0, 0, 0), Eigen::Quaterniond::Identity(),
      Eigen::Vector3d(1, 1, 1), rviz_visualizer::GREEN);

    rviz_visualizer.publishLineStrip(points, Eigen::Quaterniond::Identity(),
      0.1, rviz_visualizer::RED);
